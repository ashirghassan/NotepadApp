...
public class ItemNoteBindingImpl extends ItemNoteBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.imageViewBullet, 2);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.note == variableId) {
            setNote((com.example.notepad.Note) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setNote(@Nullable com.example.notepad.Note Note) {
        this.mNote = Note;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        java.lang.String noteText = null;
        com.example.notepad.Note note = mNote;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.textViewNote, noteText);
        }
    }
